<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditQuestion.aspx.cs" Inherits="WcfQTS_Client.EditQuestion" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="add-container">
                ...
                <asp:TextBox ID="txtTitle" runat="server" AutoPostBack="false"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="txtUrl" runat="server" TextMode="Url" AutoPostBack="false"></asp:TextBox>
            ...
            <div>
                ...
                <asp:DropDownList ID="ddlDifficulty" runat="server" AutoPostBack="false">
            ...
            <div>
                ...
                <asp:DropDownList ID="ddlRemark" runat="server" AutoPostBack="false">
            ...
            <div>
                ...
                <asp:TextBox ID="txtNote" runat="server" TextMode="MultiLine" AutoPostBack="false"></asp:TextBox>
            </div>
            <br />

            <div>
                <asp:Label ID="lblPlatform" runat="server" Text="Platform :"></asp:Label>
                <asp:DropDownList ID="ddlPlatform" runat="server" AutoPostBack="false"></asp:DropDownList>
            </div>
            <br />
            ...
            <div class="checkboxlist-container">
                <asp:CheckBoxList ID="cblTopics" runat="server" RepeatLayout="Flow" AutoPostBack="false"></asp:CheckBoxList>
            </div>
            <br />
